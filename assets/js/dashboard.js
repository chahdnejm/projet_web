(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      saleGradientBg.addColorStop(0, 'rgba(232, 167, 26, 0.18)');
      saleGradientBg.addColorStop(1, 'rgba(232, 167, 26, 0.18)');
      var saleGradientBg2 = graphGradient2.createLinearGradient(100, 0, 50, 150);
      saleGradientBg2.addColorStop(0, 'rgba(255, 167, 26, 0.18)');
      saleGradientBg2.addColorStop(1, 'rgba(232, 167, 26, 0.18)');
      var salesTopData = {
          ...
          datasets: [{
              ...
              pointBackgroundColor: ['#f6b92b)', '#f6b92b', '#f6b92b', '#f6b92b','#f6b92b)', '#f6b92b', '#f6b92b', '#f6b92b','#f6b92b)', '#f6b92b', '#f6b92b', '#f6b92b','#f6b92b)'],
              pointBorderColor: ['#ba8b1e','#ba8b1e','#ba8b1e','#ba8b1e','#ba8b1e','#ba8b1e','#ba8b1e','#ba8b1e','#ba8b1e','#ba8b1e','#ba8b1e','#ba8b1e','#ba8b1e',],
          },{
            label: 'Last week',
